...
<div class="modal-header">
    <h5 class="modal-title" id="exampleModalLongTitle">Slider</h5>
...
<div class="modal-dialog  modal-dialog-centered" role="document">
    ...
    <form enctype="multipart/form-data" action="{{route('slider-update')}}" method="post" >
        @csrf
    <div class="modal-body">
        <div class="row">
...
<div class="card shadow">
    ...
    <br>
    <div class="row">
        <div class="col-md-6"><h5 class="m-0 font-weight-bold ">Sliders</h5></div>   
        <div class="col-md-6">
      ...
      <div class="table-responsive">
       <table id="example" class="table table-bordered table-hover">
         ...
         <td>{{$s++}}</td>
          ...
          <td><img src="{{asset($cat->image)}}" style="height:150px; width:280px;"></td>
          <td><a href="" onclick= 'edit({{$cat->id}});' data-toggle="modal" id="edit" 
            ...
            <a href="{{url('/slider/delete/'.$cat->id)}}" class="btn btn-sm btn-danger" onclick='alert("Confirm Delete This Test Category ??")' >Delete</a>
